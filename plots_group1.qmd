...
p = d |>
  ...
  labs(
    ...
    subtitle = "Verändert sich die Reaktionszeit abhängig von Instruktionsbedingung \nund Korrektheit der Antwort?",
    x = "Instruktion",
    y = "Reaktionszeit (s)",
    fill = "Korrektheit der Antwort"
  ) +
...
p = d |>
  ...
  labs(title = "Random Dot Experiment: \nReaktionszeiten nach Antwortkorrektheit und Experimentalbedingung", 
       subtitle = "Sind richtige Antworten mit längeren Reaktionszeiten verbunden, \nunabhängig von der Instruktion?",
...
plot <- acc_rt_vpn |>
  ...
  labs(x = "Bedingung",
       ...
       subtitle = "Unterscheiden sich die Reaktionszeiten zwischen der Bedingung Accuracy\n und der Bedingung Speed?")
...
p <- ggplot(d_filtered, aes(x = condition, y = rt, color = condition)) +
  ...
  labs(
    ...
    subtitle = "Wie verändert sich das Entscheidungsverhalten von Menschen, \nje nachdem wie sie instruiert wurden?",
    x = "Instruktionsbedingung",
    y = "Reaktionszeit (Sekunden)",
    color = "Bedingung"
  ) +
...
p = d |>
  ...
  labs( # Beschriftungen: Titel, Subtitel
    ...
    subtitle = "Wie unterscheiden sich die Verteilungen der Reaktionszeiten \nzwischen den Bedingungen?", 
