...
Wir können nun noch die _non-decision time_ hinzufügen, und den Anfangspunkt (_bias_) der Evidenzakkumulierung. 

Die _non-decision time_ beschreibt die Zeit, welche nicht der Evidenzakkumulierung dient.
...
Der _bias_, also der Anfangspunkt ist ein sehr wichtiger Parameter der beeinflusst, ob schon vor dem Entscheidungsprozess zu einer gewissen Antwort tendiert wird (Antworttendenz).
