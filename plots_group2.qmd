...
plot_data <- mean_data |> 
  mutate(image = "imgs/clownfish.png",
         image2 = "imgs/shark.png")

img = png::readPNG("imgs/darla.png") %>%
  rasterGrob(interpolate = TRUE) 
img_1 <- readPNG("imgs/coral.png")
...
d <- d %>% 
    filter(rt <=12) # nur Reaktionszeiten unter 12ms 

p <- ggplot(d, mapping = aes(x = condition,
                     y = rt)) +
