...
- Laden Sie den Datensatz `DatasaurusDozen.csv` [hier](data/DatasaurusDozen.csv) herunter und speichern Sie diesen in dem Ordner `data` im Ordner Ihres _RProjects_.
...
Falls wir z.B. Zeilen mit fehlenden Werten hätten, könnten wir uns entschliessen diese Messungen zu löschen. Wichtig hierbei ist:
...
Für die Analyse schliessen wir alle Reaktionszeiten unter 100ms und über 10 Sekunden aus.
...
Wir schliessen alle Personen aus, die weniger als 40 gültige Trials hatten (in unserem Beispiel nicht nötig).
